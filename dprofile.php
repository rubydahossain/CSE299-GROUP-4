...
<div class="hi" > 
	<h1 class="h1" > Easy Pescribe  Doctor's Profile</h1>
	
</div>
<div class="sidebar" >
            <div class="Quick"><?php if(check_login(false)):?>
				Hi, Dr. <?=$_SESSION['USER']->username?> 
				<?php endif;?>
			</div>
            ...
            <ul>
                ...
                <li class="sidebar-link"><a href="Doctor_Information_Form.html"></i>Update Profile</a></li>
                ...
                <li class="sidebar-link"><a href="dlogout.php"><i class="fa fa-inr"></i>Logout</a>
